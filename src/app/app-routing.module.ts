...
const routes: Routes = [
  ...
  {
    path: 'clearsecuresecret',
    loadChildren: () => import('./test/testclearsecuresecret/testclearsecuresecret.module')
      .then(m => m.TestClearSecureSecretPageModule)
  },
  {
    path: 'testjson1',
  ...
  {
    path: 'json385',
    loadChildren: () => import('./test/testjson385/testjson385.module')
